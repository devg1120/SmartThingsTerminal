...
namespace SmartThingsTerminal
{
    ...
    {
        [CommandLine.Option('t', "accesstoken", Required = true, HelpText = "OAuth Personal access token - generate from: https://account.smartthings.com/tokens")]
        public string AccessToken { get; set; }

        [CommandLine.Option('s', "screen", Required = false, HelpText = "Jump into a specific screen: [devices/installedapps/locations/rules/scenes/schedules/subscriptions]")]
